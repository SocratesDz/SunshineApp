 ...
 */
package com.socratesdiaz.sunshine.data;
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        Cursor weatherCursor = db.query(WeatherContract.WeatherEntry.TABLE_NAME, null,
                WeatherContract.WeatherEntry._ID + " = " + weatherRowId, null, null, null, null);
        ...
        // query if you like)
        TestUtilities.validateCursor("Values don't match", weatherCursor, weatherTestValues);
    ...
    public long insertLocation() {
        ...
        assertTrue("There was an error inserting the row", id != -1);

        // Query the database and receive a Cursor back
        Cursor locationCursor = db.query(WeatherContract.LocationEntry.TABLE_NAME, null,
                WeatherContract.LocationEntry._ID + " = " + id, null, null, null, null);

        // Move the cursor to a valid database row
        assertTrue("Error: There are no records in the cursor", locationCursor.moveToFirst());


        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Values don't match", locationCursor, testValues);

        assertFalse("Error: There must be only one record in the cursor", locationCursor.moveToNext());
